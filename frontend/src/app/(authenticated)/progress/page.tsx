...
const mockProgressData = {
  ...
  GitHub: {
    ...
    longestStreak: 45,
    goals: [
      { title: "Daily Commits", current: 2, target: 5 },
      { title: "Weekly Pull Requests", current: 1, target: 3 },
      { title: "Contributions milestone", current: 842, target: 1000 },
    ],
    achievements: [
      { title: "First Commit", desc: "Push your first commit to GitHub", date: "Jan 15, 2024" },
      { title: "Open Sourcerer", desc: "Create a public repository", date: "Jan 20, 2024" },
      { title: "PR Champion", desc: "Merge 50 Pull Requests", date: "Jun 10, 2024" },
    ]
  }
};
...
export default function ProgressPage() {
  ...
  const [customGoals, setCustomGoals] = useState<Record<string, any[]>>({
    ...
    GitHub: [...mockProgressData.GitHub.goals]
  });
      ...
      {!hasConnections ? (
        ...
        <>
          ...
          <AnimatePresence mode="wait">
            {connectedTabs.includes(platform) && data && (
              <motion.div
                key={platform}
